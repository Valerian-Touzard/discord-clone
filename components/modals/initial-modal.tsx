...
const formSchema = z.object({
    name: z.string().min(1, {message: "Le nom du serveur est obligatoire"}),
            ...
            <DialogContent className='bg-white text-black p-0 overflow-hidden'>
                <DialogHeader className='pt-8 pw-6'>
                    ...
                    <DialogDescription className='text-center text-zinc-500'>
                        Donnez à votre serveur sa propre ambiance avec un nom et une image. Vous pourrez toujours les changer plus tard.
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
